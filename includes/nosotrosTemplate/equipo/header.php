        ...
        <div class="caja">
            <div id="sidebar-container" class="bg-primary">
                ...
                <div class="menu">
                  ...
                  <a href="/yointidev-main/admin2/informacion.php" class="d-block text-light p-3 select-menu"><i class="fa-solid fa-users mr-2"></i>Nosotros</a>
          ...
          <div class="c1">
            <nav class="navbar-expand-lg bg-light navsub">
                ...
                <div class="collapse navbar-collapse submenu" id="navbarNav">
                  <ul class="navbar-nav">
                  <li class="nav-item ">
                        <a class="nav-link " href="/yointidev-main/admin2/nosotros/informacion.php">Información</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="/yointidev-main/admin2/nosotros/galeria.php">Galería</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active1 " href="/yointidev-main/admin2/nosotros/equipo.php">Equipo</a>
                    </li>
                  </ul>
                </div>
              </nav>
