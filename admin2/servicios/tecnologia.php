    ...
    <div class="grid-layout">
        ...
        <div class="caja">
            <div id="sidebar-container" class="bg-primary">
                ...
                <div class="menu">
                  <a href="../inicio/slides.php" class="d-block text-light p-3"><i class="fa-solid fa-house-chimney  mr-2"></i></i>Inicio</a>
                  <a href="../nosotros/informacion.php" class="d-block text-light p-3"><i class="fa-solid fa-users mr-2"></i>Nosotros</a>
                  <a href="./tecnologia.php" class="d-block text-light p-3  select-menu"><i class="fa-solid fa-laptop-code mr-2"></i>Servicios</a>
                  <a href="../proyectos/proyectos.php" class="d-block text-light p-3"><i class="fa-solid fa-folder-open mr-2"></i>Proyectos</a>
                  <a href="../blog/publicaciones.php" class="d-block text-light p-3"><i class="fa-regular fa-id-card mr-2"></i></i>Blog</a>
                  <a href="../admins/administradores.php" class="d-block text-light p-3"><i class="fa-solid fa-user-tie mr-2"></i>Admins</a>
                </div>
          ...
          <div class="c1">
            <nav class="navbar-expand-lg bg-light navsub">
                ...
                <div class="collapse navbar-collapse submenu" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item ">
                        <a class="nav-link active1" href="./tecnologia.php">Tecnología</a>
                    </li>
                    <li class="nav-item">
