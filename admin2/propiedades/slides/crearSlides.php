<?php
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($errores)){
      ...
      $query = "INSERT INTO slides (title, sub_title, imagen) values ('$titulo', '$subtitulo','$nombreImage')";
...
?>
      ...
      <form  method="post" action="crearSlides.php" enctype="multipart/form-data">
          <section>
