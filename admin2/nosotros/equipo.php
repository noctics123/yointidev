<?php
  require '../../includes/funciones5.php';
  incluirTemplateEquipo('header');
?>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Chief Wizard Officer</td>
                            <td>
                              <table class="table microtable">
                                <tbody>
                                  <tr>
                                    <td class="microfila">https://www.instagram.com/eeffyy___/</td>
                                  </tr>
                                  <tr>
                                    <td class="microfila">https://www.facebook.com/effyasd.007</td>
                                  </tr>
                                  <tr>
                                    <td class="microfila">https://www.linkedin.com/in/antoniofernandez/</td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
