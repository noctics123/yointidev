            ...
            <nav class="navbar-expand-lg bg-light navsub">
                ...
                <div class="collapse navbar-collapse submenu" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active1" href="./estadisticas.php">Estadísticas</a>
                    </li>
                  </ul>
                </div>
              </nav>
                ...
                <div class="tablero">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">1</th>
                        <td>Clientes satisfechos con nuestro servicio digital</td>
                        <td>337</td>
                      ...
                      <tr>
                        <th scope="row">2</th>
                        <td>Nuevos
                          Clientes este año</td>
                        <td>40</td>
                        <td><button> X</button></td>
                      </tr>
                      <tr>
                        <th scope="row">3</th>
                        <td>De incremento de facturación anual</td>
                        <td>27%</td>
                        <td><button> X</button></td>
                      </tr>
                    </tbody>
