        ...
        <div class="caja">
            <div id="sidebar-container" class="bg-primary">
                ...
                <div class="menu">
                  ...
                  <a href="./proyectos.html" class="d-block text-light p-3  select-menu"><i class="fa-solid fa-folder-open mr-2"></i>Proyectos</a>
          ...
          <div class="c1">
            <nav class="navbar-expand-lg bg-light navsub">
                ...
                <div class="collapse navbar-collapse submenu" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item ">
                        <a class="nav-link active1" href="./proyectos.html">Nuestros Proyectos</a>
                    </li>
                  </ul>
                </div>
              </nav>
                      ...
                      <div class="row ">
                          ...
                          <div class="col-lg-6 ">
                            <table class="table tableinfo">
                              <tbody>
                                <tr>
                                  <th scope="col">Nuestros Proyectos</th>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><table class="table microtable">
                          <tbody>
                            <tr>
                              <td class="microfila">/gallery/thepicture1.png</td>
                            </tr>
                            <tr>
                              <td class="microfila">/gallery/thepicture1.png</td>
                            </tr>
