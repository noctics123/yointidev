        ...
        <div class="caja">
            <div id="sidebar-container" class="bg-primary">
                ...
                <div class="menu">
                  ...
                  <a href="./publicaciones.html" class="d-block text-light p-3 select-menu"><i class="fa-regular fa-id-card mr-2"></i></i>Blog</a>
          ...
          <div class="c1">
            <nav class="navbar-expand-lg bg-light navsub">
                ...
                <div class="collapse navbar-collapse submenu" id="navbarNav">
                  <ul class="navbar-nav">
                    <li class="nav-item ">
                        <a class="nav-link active1" href="./publicaciones.html">Publicaciones</a>
                    </li>
                    <li class="nav-item ">
                      ...
                      <tr>
                        ...
                        <td>
                            <table class="table microtable">
                                <tbody>
                                    <tr>
                                        <td class="microfila">//admin/blog/publicaciones.html</td>
                                        </tr>
                                        <tr>
                                        <td class="microfila">//admin/blog/publicaciones.html</td>
                                    </tr>
